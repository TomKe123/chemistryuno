...
│   ├── MOBILE_TROUBLESHOOTING.md           # 移动端故障排除
│   ├── REJOIN_FIX.md                       # 重新加入功能说明
...
│           ├── GameLobby.css               # 大厅样式
│           ├── GameBoard.js                # 游戏界面 (200+ 行)
│           ├── GameBoard.css               # 游戏样式
│           ├── Card.js                     # 卡牌组件 (30+ 行)
│           ├── Card.css                    # 卡牌样式
│           ├── CompoundSelector.js         # 物质选择器 (80+ 行)
│           ├── CompoundSelector.css        # 选择器样式
│           ├── AdminPanel.js               # 管理面板 (300+ 行)
│           ├── AdminPanel.css              # 管理面板样式
│           ├── AdminLogin.js               # 管理员登录 (80+ 行)
│           └── AdminLogin.css              # 登录样式
│
└── 🔧 项目根配置
